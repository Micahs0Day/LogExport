...
resource "azurerm_private_endpoint" "kv_ple" {
  name                = "ple-${var.project_name}-${random_string.suffix.result}-kv"
...
resource "azurerm_private_endpoint" "st_ple_blob" {
  name                = "ple-${var.project_name}-${random_string.suffix.result}-st-blob"
  location            = var.location
  resource_group_name = var.resource_group_name
  subnet_id           = azurerm_subnet.mlws-subnet.id
...
resource "azurerm_private_endpoint" "storage_ple_file" {
  name                = "ple-${var.project_name}-${random_string.suffix.result}-st-file"
  location            = var.location
  resource_group_name = var.resource_group_name
  subnet_id           = azurerm_subnet.mlws-subnet.id
...
resource "azurerm_private_endpoint" "mlw_ple" {
  name                = "ple-${var.project_name}-${random_string.suffix.result}-mlw"
  location            = var.location
  resource_group_name = var.resource_group_name
  subnet_id           = azurerm_subnet.mlws-subnet.id
